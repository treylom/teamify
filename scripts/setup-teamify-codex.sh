#!/usr/bin/env bash
# setup-teamify-codex.sh — /teamify_codex 원클릭 환경 설정
# Usage: bash .claude/scripts/setup-teamify-codex.sh
#
# 이 스크립트는 /teamify_codex 실행에 필요한 모든 의존성을 확인하고,
# 누락된 항목을 자동 설치합니다.
#
# 의존성:
...
header() {
  echo ""
  echo -e "${BOLD}${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
  echo -e "${BOLD}${BLUE}  /teamify_codex — Setup & Dependency Check${NC}"
  echo -e "${BOLD}${BLUE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
  echo ""
}
...
summary() {
  ...
  if [[ ${failed} -eq 0 ]]; then
    echo -e "  ${GREEN}${BOLD}All checks passed! /teamify_codex 실행 준비 완료.${NC}"
    echo ""
  ...
  echo -e "    ${CYAN}RUN_PROXY_TEST=1 bash .claude/scripts/setup-teamify-codex.sh${NC}"
  echo ""
}
